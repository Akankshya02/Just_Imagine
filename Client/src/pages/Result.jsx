...
{!isImageLoaded &&
    ...
    <div className='flex w-full max-w-xl bg-pink-300 text-black text-sm p-0.5 mt-10 rounded-full'>
      ...
      type="text" placeholder='Jot Down your thoughts' className='flex-1 bg-transparent otline-none ml-8 max-sm:w-20 placeholder-color'/>
...
{isImageLoaded && 
    ...
    <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
      <p onClick={()=>{setImageLoaded(false)}}  className='bg-transparent border border-pink-900 text-black px-8 py-3 rounded-full curosor-pointer'>
        Generate Another
      </p>
